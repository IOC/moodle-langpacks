...
/**
 * Strings for component 'block_online_users', language 'es', branch 'MOODLE_25_STABLE'
 *
...
$string['online_users:myaddinstance'] = 'Añadir un nuevo bloque de usuarios conectados a la página Mi Moodle';
