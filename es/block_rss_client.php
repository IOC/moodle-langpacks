...
/**
 * Strings for component 'block_rss_client', language 'es', branch 'MOODLE_25_STABLE'
 *
...
$string['rss_client:myaddinstance'] = 'Añadir un nuevo bloque de canal RSS a la página Mi Moodle';
