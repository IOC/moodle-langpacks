...
/**
 * Strings for component 'choicegroup', language 'es', branch 'MOODLE_25_STABLE'
 *
 * @package   choicegroup
...
$string['fillinatleastoneoption'] = 'Es necesario proporcionar como mínimo dos posibles respuestas';
