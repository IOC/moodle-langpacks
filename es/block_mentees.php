...
/**
 * Strings for component 'block_mentees', language 'es', branch 'MOODLE_25_STABLE'
 *
...
$string['mentees:myaddinstance'] = 'Añadir un nuevo bloque mentees a la página Mi Moodle';
