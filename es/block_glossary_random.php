...
/**
 * Strings for component 'block_glossary_random', language 'es', branch 'MOODLE_25_STABLE'
 *
...
$string['glossary_random:myaddinstance'] = 'Añadir un nuevo bloque de entrada aleatoria del glosario a la página Mi Moodle';
