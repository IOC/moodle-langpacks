...
/**
 * Strings for component 'block_community', language 'es', branch 'MOODLE_25_STABLE'
 *
...
$string['community:myaddinstance'] = 'Añadir un nuevo bloque buscador de comunidad en la página Mi Moodle';
