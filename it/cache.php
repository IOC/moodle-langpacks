...
/**
 * Strings for component 'cache', language 'it', branch 'MOODLE_25_STABLE'
 *
 * @package   cache
...
$string['cachedef_plugininfo_base'] = 'Informazioni plugin - base';
$string['cachedef_plugininfo_block'] = 'Informazioni plugin - blocchi';
$string['cachedef_plugininfo_filter'] = 'Informazioni plugin - filtri';
$string['cachedef_plugininfo_mod'] = 'Informazioni plugin - moduli di attività';
$string['cachedef_plugininfo_portfolio'] = 'Informazioni plugin - portfolio';
$string['cachedef_plugininfo_repository'] = 'Informazioni plugin - repository';
$string['cachedef_pluginlist'] = 'Elenco plugin';
$string['cachedef_plugintypes'] = 'Tipi di plugin';
