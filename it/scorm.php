...
/**
 * Strings for component 'scorm', language 'it', branch 'MOODLE_25_STABLE'
 *
 * @package   scorm
...
$string['maximumattempts_help'] = 'Imposta il numero massimo di tentativi consentiti. Funziona solamente per pacchetti SCORM.2 e AICC.';
