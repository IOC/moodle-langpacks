...
/**
 * Strings for component 'moodle', language 'it', branch 'MOODLE_25_STABLE'
 *
 * @package   moodle
...
$string['blockdeleteconfirm'] = 'Stai per rimuovere il blocco \'{$a}\'. Saranno anche eliminati tutti i dati presenti nel database relativi al blocco. Sei sicuro ?';
...
$string['format_help'] = 'I formati impostano la visualizzazione della home page del corso.

* Formato SCORM - Consente di visualizzare un pacchetto SCORM nella prima sezione del corso (in alternativa all\'utilizzo del modulo di attività SCORM)
* Formato Relazionale - Il corpo centrale della home page del corso visualizzerà un forum
...
$string['local'] = 'Locale';
$string['localplugindeleteconfirm'] = 'Stai per rimuovere il local plugin \'{$a}\'. Saranno anche eliminati tutti i dati presenti nel database relativi a questo plugin. Sei sicuro ?';
...
$string['moduledeleteconfirm'] = 'Stai per rimuovere il modulo \'{$a}\'. Saranno anche eliminati tutti i dati presenti nel database relativi a questo modulo. Sei sicuro ?';
...
$string['resourcedisplayembed'] = 'Incoprora';
