...
/**
 * Strings for component 'repository', language 'it', branch 'MOODLE_25_STABLE'
 *
 * @package   repository
...
$string['displaydetails'] = 'Visualizza cartella con i dettagli dei file';
$string['displayicons'] = 'Visualizza cartella con icone dei file';
$string['displaytree'] = 'Visualizza la cartella con l\'alberatura dei file';
