...
/**
 * Strings for component 'question', language 'it', branch 'MOODLE_25_STABLE'
 *
 * @package   question
...
$string['questionpreviewdefaults_desc'] = 'I default vengono utilizzati quando u utente visualizza l\'anteprima di una domanda presente nel deposito delle domande. Dopo che la domanda è stata visualizzata in anteprima per la prima volta, le preferenze personali saranno memorizzate come preferenze dell\'utente.';
