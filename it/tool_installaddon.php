...
/**
 * Strings for component 'tool_installaddon', language 'it', branch 'MOODLE_25_STABLE'
 *
...
$string['validationmsg_componentmismatchname'] = 'Discrepanza sul nome del pluign';
...
$string['validationmsg_componentmismatchtype'] = 'Discrepanza sul tipo di pluign';
...
$string['validationmsg_pluginversion'] = 'Versione pluign';
$string['validationmsg_release'] = 'Release plugin';
$string['validationmsg_requiresmoodle'] = 'Versione Moodle richeista';
