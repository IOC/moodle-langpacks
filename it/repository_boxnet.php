...
/**
 * Strings for component 'repository_boxnet', language 'it', branch 'MOODLE_25_STABLE'
 *
...
$string['apiv1migration_message_content'] = 'Per effetto dell\'aggiornamento a Moodle 2.5.3, il plugin repository Box.net è stato disabilitato. Per riabilitarlo, devi riconfigurarlo in accordo la istruzioni presenti nella documentazione {$a->docsurl}.';
