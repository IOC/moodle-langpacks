...
/**
 * Strings for component 'cachestore_memcached', language 'it', branch 'MOODLE_25_STABLE'
 *
...
$string['prefix_help'] = 'Consente la creazione di un "dominio" per gli elementi di una chiave, consentendo di avere store memcahced multipli in un\'unica  installazione memcahded. Il prefisso non deve superare i 16 caratteri per evitare problemi di lunghezza della chiave.';
