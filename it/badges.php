...
/**
 * Strings for component 'badges', language 'it', branch 'MOODLE_25_STABLE'
 *
 * @package   badges
...
$string['attachment_help'] = 'Consente di allegare l\'immagine del badge nel messaggio indirizzato al destinatario';
...
$string['badgesalt'] = 'Salt per l\'hasing dell\'indirizzo email del destinatario';
...
$string['coursecompletion'] = 'I partecipanti devono completare il corso';
...
$string['criteria_descr'] = 'I partecipanti conseguono il badge al soddisfacimento dei requisti elencati:';
$string['criteria_descr_0'] = 'I partecipanti conseguono il badge se i requisiti elencati (<strong>{$a}</strong>) sono soddisfatti';
...
$string['criteria_descr_4'] = 'I partecipanti devono completare il corso';
...
$string['criteria_descr_single_4'] = 'I partecipanti devono completare il corso';
...
$string['criterror_help'] = 'Di seguito vengono visualizzati tutti i parametri non più disponibili ma che sono stati impostati per i criteri di rilascio del badge. Si raccomanda di deselezionare tali parametri per garantire che il badge possa essere nuovamente conseguito.';
