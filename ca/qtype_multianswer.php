...
/**
 * Strings for component 'qtype_multianswer', language 'ca', branch 'MOODLE_25_STABLE'
 *
...
$string['pluginname'] = 'Respostes incrustades (buits)';
...
$string['pluginname_help'] = 'Les respostes incrustades a les activitats (de buits) consisteixen en un text amb preguntes com respostes de selecció múltiple i respostes curtes incrustades.';
