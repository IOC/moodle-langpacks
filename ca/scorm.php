...
/**
 * Strings for component 'scorm', language 'ca', branch 'MOODLE_25_STABLE'
 *
 * @package   scorm
...
$string['elementdefinition'] = 'Definició de l\'element';
$string['enter'] = 'Entra';
...
$string['interactionscorrectcount'] = 'Nombre de resultats correcte per a la pregunta';
$string['interactionsid'] = 'Id de l\'element';
$string['interactionslatency'] = 'Temps transcorregut entre el moment que l\'alumne te disponible la interacció i el moment de la primera resposta';
$string['interactionslearnerresponse'] = 'Resposta de l\'alumne';
$string['interactionspattern'] = 'Patró de resposta correcta';
$string['interactionsresponse'] = 'Resposta de l\'estudiant';
$string['interactionsresult'] = 'Resultat basat en la resposta de l\'estudiant i el resultat correcte';
$string['interactionsscoremax'] = 'Valor màxim dintre del rang possible de puntuacions';
$string['interactionsscoremin'] = 'Valor mínim dintre del rang possible de puntuacions';
$string['interactionsscoreraw'] = 'Nombre que reflexa el resultat de l\'alumne en relació amb el rang delimitat pels valors mínim i màxim';
$string['interactionssuspenddata'] = 'Proporciona espai per emmagatzemar i recuperar dades entre sessions d\'aprenentatge';
$string['interactionstime'] = 'Hora en la que es va iniciar l\'intent';
$string['interactionstype'] = 'Tipus de pregunta';
$string['interactionsweight'] = 'Pes assignat a l\'element';
