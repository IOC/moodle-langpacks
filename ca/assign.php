...
/**
 * Strings for component 'assign', language 'ca', branch 'MOODLE_25_STABLE'
 *
 * @package   assign
...
$string['duedate_help'] = 'Açò és quan la tasca venç. Es permet retard en la tramesa, però qualsevol tramesa enviada després d\'aquesta data es marcarà com a entregada amb retard. Per tal d\'evitar que es pugui trametre passada certa data, establiu una data de tall a la tasca.';
...
$string['requiresubmissionstatementassignment'] = 'Requereix que els estudiants acceptin el compromís de tramesa';
$string['requiresubmissionstatementassignment_help'] = 'Requereix que els estudiants acceptin el compromís de tramesa per totes les trameses d\'aquesta tasca.';
$string['requiresubmissionstatement_help'] = 'Requereix que els estudiants acceptin el compromís de tramesa per totes les trameses d\'aquesta instal·lació de Moodle. Si aquesta opció no està habilitada, aleshores el compromís de tramesa es pot habilitar o deshabilitar en cada tasca.';
...
$string['teamsubmissiongroupingid'] = 'Agrupament pels grups d\'estudiants';
