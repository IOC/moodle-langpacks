...
/**
 * Strings for component 'role', language 'ca', branch 'MOODLE_25_STABLE'
 *
 * @package   role
...
$string['checkglobalpermissions'] = 'Comprovar els permisos del sistema';
$string['checkpermissions'] = 'Comprovar els permisos';
$string['checkpermissionsin'] = 'Comprovar els permisos a {$a}';
$string['checksystempermissionsfor'] = 'Comprovar els permisos de {$a->fullname}';
$string['checkuserspermissionshere'] = 'Comprovar els permisos que {$a->fullname} té en aquest {$a->contextlevel}';
...
$string['confirmaddadmin'] = 'Ralment voleu afegir l\'usuari <strong>{$a}</strong> com a nou administrador del lloc?';
...
$string['course:markcomplete'] = 'Marcar usuaris com a completats en la finalització del curs';
...
$string['course:viewsuspendedusers'] = 'Pot mostrar els usuaris suspesos.';
...
$string['frontpageuserdescription'] = 'Tots els usuaris amb sessió inicialda al curs de la primera plana.';
...
$string['manager'] = 'Administrador/a';
$string['managerdescription'] = 'Els administradors poden accedir als cursos i modificar-los. Normalment no participen als cursos.';
