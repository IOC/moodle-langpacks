...
/**
 * Strings for component 'qtype_multichoice', language 'ca', branch 'MOODLE_25_STABLE'
 *
...
$string['errfractionsnomax'] = 'Una de les respostes ha de tenir una puntuació del 100% de manera que sigui possible aconseguir tots els punts en aquesta pregunta.';
...
$string['fractionsnomax'] = 'Una de les respostes hauria de ser 100%, de manera que sigui<br />possible obtenir el total de la qualificació en aquesta pregunta.<br />Voleu tornar enrere i arreglar aquest punt?';
$string['incorrectfeedback'] = 'Per a qualsevol resposta incorrecta';
$string['notenoughanswers'] = 'Aquest tipus de pregunta requereix almenys {$a} respostes';
