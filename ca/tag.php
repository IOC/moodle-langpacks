...
/**
 * Strings for component 'tag', language 'ca', branch 'MOODLE_25_STABLE'
 *
 * @package   tag
...
$string['entertags'] = 'Entreu les etiquetes separades per comes';
...
$string['othertags'] = 'Altres etiquetes (entreu les etiquetes separades per comes)';
