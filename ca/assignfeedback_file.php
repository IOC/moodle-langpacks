...
/**
 * Strings for component 'assignfeedback_file', language 'ca', branch 'MOODLE_25_STABLE'
 *
...
$string['enabled_help'] = 'Si està habilitat, el professorat podrà carregar fitxers amb retroacció quan qualifiqui les tasques. Aquests fitxers poden ser documents amb comentaris o retroaccions d\'àudio parlat, però no tenen per què limitar-se a qualificar les trameses de l\'estudiantat.';
...
$string['filesadded'] = 'S\'ha afegit la retroacció dels fitxers: {$a}';
$string['filesupdated'] = 'S\'ha actualitzat la retroacció dels fitxers: {$a}';
...
$string['uploadzip'] = 'Fitxers de retroacció importats d\'un zip';
