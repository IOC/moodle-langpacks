...
/**
 * Strings for component 'cache', language 'ca', branch 'MOODLE_25_STABLE'
 *
 * @package   cache
...
$string['cachedef_plugininfo_base'] = 'Informació del connector - base';
$string['cachedef_plugininfo_block'] = 'Informació del connector - blocs';
$string['cachedef_plugininfo_filter'] = 'Informació del connector - filtres';
$string['cachedef_plugininfo_mod'] = 'Informació del connector - mòduls d\'activitat';
$string['cachedef_plugininfo_portfolio'] = 'Informació del connector - portafolis';
$string['cachedef_plugininfo_repository'] = 'Informació del connector - repositoris';
$string['cachedef_pluginlist'] = 'Llista de connectors';
$string['cachedef_plugintypes'] = 'Tipus de connectors';
