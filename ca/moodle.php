...
/**
 * Strings for component 'moodle', language 'ca', branch 'MOODLE_25_STABLE'
 *
 * @package   moodle
...
$string['force'] = 'Imposa';
$string['forcedmodeinbrackets'] = '{$a} (mode forçat)';
...
$string['localpluginsmanage'] = 'Gestiona els connectors';
...
$string['nameforpage'] = 'Què voleu enllaçar amb aquesta pàgina?';
...
$string['uploadlimitwithsize'] = '{$a->contextname} límit de pujada ({$a->displaysize})';
