...
/**
 * Strings for component 'plugin', language 'ca', branch 'MOODLE_25_STABLE'
 *
 * @package   plugin
...
$string['filtercontribonly'] = 'Mostra només contribucions';
$string['filtercontribonlyactive'] = 'S\'estan mostrant només contribucions';
...
$string['numextension'] = 'Contribucions: {$a}';
...
$string['type_qbehaviour_plural'] = 'Preguntes de comportament';
