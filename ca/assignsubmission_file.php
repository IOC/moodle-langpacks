...
$string['enabled'] = 'Trameses de fitxers';
$string['enabled_help'] = 'Si està habilitat, l\'estudiantat podrà carregar un o més fitxers com a tramesa.';
$string['file'] = 'Trameses de fitxers';
$string['maxbytes'] = 'Mida màxima del fitxer';
$string['maxfilessubmission'] = 'Quantitat màxima de fitxers carregats';
$string['maxfilessubmission_help'] = 'Si les trameses de fitxers estan habilitades, cada estudiant podrà carregar aquesta quantitat de fitxers en la seva tramesa.';
...
$string['pluginname'] = 'Trameses de fitxers';
