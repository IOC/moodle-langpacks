...
/**
 * Strings for component 'webservice', language 'de', branch 'MOODLE_25_STABLE'
 *
 * @package   webservice
...
$string['enablemobilewsoverview'] = 'Öffnen Sie die Seite {$a->manageservicelink}. Haken Sie die Einstellung {$a->enablemobileservice} an. Mit dem Speichern werden weitere Einstellungen automatisch gesetzt. Moodle Mobile kann jetzt von allen Personen verwendet werden. Derzeitiger Status: {$a->wsmobilestatus}';
