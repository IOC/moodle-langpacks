...
$string['remoterequestpermcheck'] = 'Es wird versucht {$a->name} ({$a->component}) Version {$a->version} aus dem Moodle Plugins-Verzeichnis auf dieser Website zu installieren. Das Verzeichnis zur Installation dieses Plugin-Typs <strong>{$a->typepath}</strong> ist jedoch auf dem Server <strong>nicht beschreibbar</strong>. Sie müssen für dieses Verzeichnis zunächst Schreibrechte vergeben und dann die Taste "Weiter" klicken, um die Prüfung fortzusetzen.';
