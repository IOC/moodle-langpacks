...
/**
 * Strings for component 'block_quickmail', language 'de', branch 'MOODLE_25_STABLE'
 *
...
$string['no_usergroups'] = 'Es gibt in Ihrer Gruppe keine Nutzer, die Sie anschreiben könnten.';
