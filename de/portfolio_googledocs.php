...
/**
 * Strings for component 'portfolio_googledocs', language 'de', branch 'MOODLE_25_STABLE'
 *
...
$string['oauth2upgrade_message_subject'] = 'Wichtige Informationen zum Google Docs Portfolio';
