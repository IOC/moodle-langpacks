...
/**
 * Strings for component 'quiz', language 'de', branch 'MOODLE_25_STABLE'
 *
 * @package   quiz
...
$string['cannotreviewopen'] = 'Sie können diesen Versuch nicht prüfen, weil er noch geöffnet ist';
...
$string['delay1st2nd_help'] = 'Wenn Sie hier eine Pause einrichten, lässt sich ein zweiter Testversuch erst nach Ablauf dieser Pause durchführen.';
$string['delay2'] = 'Pause bei späteren Versuchen';
$string['delaylater'] = 'Erzwungener Abstand zwischen weiteren Versuchen';
$string['delaylater_help'] = 'Wenn Sie hier eine Pause einrichten, lassen sich der dritte und weitere Testversuche erst nach Ablauf dieser Pause starten.';
...
Um den Testversuch jetzt abzuschließen, gehen Sie auf {$a->attemptsumaryurl} und klicken Sie die Taste \'Abgeben\'. Sie müssen dies vor dem {$a->attemptgracend} tun. Andernfalls wird der Versuch nicht gewertet.';
