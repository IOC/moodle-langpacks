...
$string['notwritable_help'] = 'Sie haben die automatische Bereitstellung von Plugin-Updates aktiviert. Für dieses Plugin steht ein Update zur Verfügung. Die Plugin-Dateien auf dem Server können jedoch nicht überschrieben werden. Das automatische Update kann daher nicht ausgeführt werden.
...
$string['updatepluginconfirminfo'] = 'Sie sind dabei, eine neue Version des Plugins <strong> {$a->name}</strong> zu installieren. Das ZIP-Paket des Plugins mit der Version {$a->version} wird heruntergeladen und entpackt. Anschließend wird das Plugin installiert.
<br />Quelle: <a href="{$a->url}">{$a->url}</a>';
$string['updatepluginconfirmwarning'] = 'Eine automatische Datenbanksicherung wird vor der Aktualisierung nicht durchgeführt. Der neue Code könnte die Datenbank beschädigen. Seien Sie also vorsichtig!';
