...
/**
 * Strings for component 'qtype_numerical', language 'de', branch 'MOODLE_25_STABLE'
 *
...
$string['addmoreunitblanks'] = 'Leerfelder für {no} weitere Abschnitt(e)';
...
$string['units'] = 'Abschnitte';
$string['unitselect'] = 'ein Drop-Down-menu';
$string['unitx'] = 'Abschnitt {no}';
