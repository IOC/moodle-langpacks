...
/**
 * Strings for component 'auth', language 'de', branch 'MOODLE_25_STABLE'
 *
 * @package   auth
...
$string['authinstructions'] = 'Hier können Sie Hinweise geben, welche Anmeldenamen und Kennworte verwendet werden sollen. Der eingegebene Text erscheint auf der Anmeldeseite. Wenn Sie nichts eingeben, wird der Standardtext aus dem Sprachpaket benutzt.';
$string['auth_invalidnewemailkey'] = 'Fehler: Falls Sie gerade die Änderung Ihrer E-Mail-Adresse bestätigen wollten, haben Sie wahrscheinlich einen Fehler beim Kopieren der zugesandten URL gemacht. Kopieren Sie die URL erneut und versuchen Sie es noch einmal.';
