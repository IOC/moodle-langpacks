...
/**
 * Strings for component 'auth_ldap', language 'de', branch 'MOODLE_25_STABLE'
 *
 * @package   auth_ldap
...
$string['auth_ldap_bind_dn'] = 'Falls Sie für die Nutzerabfrage einen \'Bind-User\' verwenden müssen, so tragen Sie hier dessen Anmeldenamen ein.  Der Eintrag hat üblicherweise die folgende Form: \'cn=ldapuser,ou=public,o=org\'.';
...
$string['start_tls'] = 'LDAP Service mit TLS Verschlüsselung (Port 389) verwenden';
$string['start_tls_key'] = 'TLS verwenden';
