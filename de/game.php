...
$string['confighidebookquiz'] = 'Einstellen, ob das Spiel "Buch mit Fragen" in der Aktivitätenauswahl angezeigt und angelegt werden kann';
$string['confighidecross'] = 'Einstellen, ob das Spiel "Kreuzworträtsel" in der Aktivitätenauswahl angezeigt und angelegt werden kann';
$string['confighidecryptex'] = 'Einstellen, ob das Spiel "Suchrätsel" in der Aktivitätenauswahl angezeigt und angelegt werden kann';
$string['confighidehangman'] = 'Einstellen, ob das Spiel "Galgenmännchen" in der Aktivitätenauswahl angezeigt und angelegt werden kann';
$string['confighidehiddenpicture'] = 'Einstellen, ob das Spiel "Verstecktes Bild" in der Aktivitätenauswahl angezeigt und angelegt werden kann';
$string['confighidemillionaire'] = 'Einstellen, ob das Spiel "Wer wird Millionär" in der Aktivitätenauswahl angezeigt und angelegt werden kann';
$string['confighidesnakes'] = 'Einstellen, ob das Spiel "Schlangen und Leitern" in der Aktivitätenauswahl angezeigt und angelegt werden kann';
$string['confighidesudoku'] = 'Einstellen, ob das Spiel "Sudoku" in der Aktivitätenauswahl angezeigt und angelegt werden kann';
...
$string['gameopenclose'] = 'Start- und Endzeiten';
$string['gameopenclose_help'] = 'Teilnehmer können nur in dem Zeitraum Versuche durchführen während das Spiel geöffnet ist.';
