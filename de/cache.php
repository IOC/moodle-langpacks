...
/**
 * Strings for component 'cache', language 'de', branch 'MOODLE_25_STABLE'
 *
 * @package   cache
...
$string['cachedef_plugininfo_base'] = 'Plugin-Info - Basis';
$string['cachedef_plugininfo_block'] = 'Plugin-Info - Blöcke';
$string['cachedef_plugininfo_filter'] = 'Plugin-Info - Filter';
$string['cachedef_plugininfo_mod'] = 'Plugin-Info - Aktivitäten';
...
$string['cachedef_pluginlist'] = 'Plugin-Liste';
$string['cachedef_plugintypes'] = 'Plugin-Typen';
...
$string['testperformance'] = 'Leistung testen';
