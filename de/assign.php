...
/**
 * Strings for component 'assign', language 'de', branch 'MOODLE_25_STABLE'
 *
 * @package   assign
...
$string['attemptreopenmethod'] = 'Lösungen erneut geöffent';
...
$string['currentattemptof'] = 'Dies ist Versuch {$a->attemptnumber} ({$a->maxattempts} Versuche sind möglich)';
