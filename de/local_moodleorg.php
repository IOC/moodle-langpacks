...
/**
 * Strings for component 'local_moodleorg', language 'de', branch 'MOODLE_25_STABLE'
 *
...
$string['aboutstatisticsheading'] = 'Moodle-Statistik';
$string['aboutstatisticstitle'] = 'Moodle.org: Moodle-Statistik';
$string['activeusers24hours'] = 'Zugriffe von registrierten Nutzer/innen während der letzten 24 Stunden:';
$string['activeuserspastmonth'] = 'Zugriffe von registrierten Nutzer/innen während des letzten Monats:';
$string['communityintro'] = 'Moodle besitzt eine große und vielseitige Nutzer-Community mit über <a href="http://moodle.org/userpics">{$a->usercount} registierten Nutzer/innen</a> alleine auf dieser Moodle-Website, die mehr als <a href="http://download.moodle.org/lang16/">{$a->langcount} Sprachen</a> sprechen und in <a href="http://moodle.org/sites">{$a->countrycount} Ländern</a> leben ... und wir haben noch viele <a href="http://moodle.org/stats">weitere Statistiken</a> für Sie.';
...
$string['donationsmoney'] = 'Sie können auch Geld direkt in den Fond einzahlen. Das gesamte Geld wird benutzt, um die Wünsche zur Roadmap zu realisieren. Um eine Spende per Kreditkarte in beliebigen Währungen zu leisten, klicken Sie bitte auf die Taste "Paypal". <br /><br />Spender von mehr als $10 können ihren Namen für ein Jahr auf dieser Seite eintragen. Vergessen Sie in diesem Fall nicht, nach der Zahlung die Taste "Weiter" zu drücken, um das entsprechende Formular aufzurufen und sich einzutragen.';
...
$string['newsofficial'] = 'Offizielle Nachrichten über Moodle';
$string['newsplanet'] = 'Planet-Moodle';
$string['newsplanetdetail'] = 'Gesammelte Blogs der Moodle-Entwickler';
$string['newsrecent'] = 'Neue Nachrichten';
$string['newssecurity'] = 'Sicherheitsmitteilungen';
...
$string['overviewabout'] = 'Eine Übersicht zu Moodle';
$string['overviewcommunity'] = 'Eine Übersicht zur Moodle-Community';
$string['overviewdevelopment'] = 'Eine Übersicht zur Moodle-Entwicklung';
$string['overviewdownloads'] = 'Eine Übersicht zu allen Moodle-Downloads';
$string['overviewmy'] = 'Alle Bereiche anzeigen, in denen Sie bei Moodle.org eingeschrieben sind';
$string['overviewnews'] = 'Eine Übersicht über die aktuellen Moodle-Nachrichten';
$string['overviewsupport'] = 'Eine Übersicht über die Moodle-Supportmöglichkeiten';
