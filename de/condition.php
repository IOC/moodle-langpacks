...
/**
 * Strings for component 'condition', language 'de', branch 'MOODLE_25_STABLE'
 *
 * @package   condition
...
$string['userrestriction_hidden'] = 'Beschränkt (verborgen, kein Hinweis): {$a}';
$string['userrestriction_visible'] = 'Beschränkt: {$a}';
