...
$string['unusedvar'] = 'Cette varaible n\'est utilisée par aucune réponse';
$string['uri'] = 'Uri du serveur SAGE';
$string['variable'] = 'Nom de variable';
...
$string['varmingtmax'] = 'La valeur minimum doit être inférieure à la valeur maximum';
