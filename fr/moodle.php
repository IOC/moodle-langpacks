...
/**
 * Strings for component 'moodle', language 'fr', branch 'MOODLE_25_STABLE'
 *
 * @package   moodle
...
$string['manageroles'] = 'Rôles et droits d\'accès';
