...
/**
 * Strings for component 'webservice', language 'fr', branch 'MOODLE_25_STABLE'
 *
 * @package   webservice
...
$string['cannotcreatetoken'] = 'Pas de droits d\'accès pour créer un jeton de service web pour le service {$a}.';
