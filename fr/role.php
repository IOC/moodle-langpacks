...
/**
 * Strings for component 'role', language 'fr', branch 'MOODLE_25_STABLE'
 *
 * @package   role
...
$string['archetype_help'] = 'Le rôle modèle détermine les permissions affectées à un rôle lors de sa réinitialisation. Il détermine également les nouveaux droits d\'accès lors d\'une mise à jour du site.';
...
$string['checkglobalpermissions'] = 'Vérifier les droits d\'accès système';
$string['checkpermissions'] = 'Voir les droits d\'accès';
$string['checkpermissionsin'] = 'Voir les droits d\'accès dans {$a}';
$string['checksystempermissionsfor'] = 'Vérifier les droits d\'accès système de {$a->fullname}';
$string['checkuserspermissionshere'] = 'Voir les droits d\'accès de {$a->fullname} dans ce {$a->contextlevel}';
...
$string['course:viewsuspendedusers'] = 'Peut voir les utilisateurs suspendus';
...
$string['hidden'] = 'Caché';
$string['highlightedcellsshowdefault'] = 'Les cellules en surbrillance dans le tableau ci-dessous indiquent le droits d\'accès par défaut pour le rôle modèle spécifié ci-dessus.';
$string['highlightedcellsshowinherit'] = 'Les cellules en surbrillance dans le tableau ci-dessous indiquent s\'il y a lieu le droits d\'accès qui sera hérité. À part les capacités dont vous voulez modifier les droits d\'accès, il est suggéré de laisser le tout sur Hériter.';
...
$string['neededroles'] = 'Rôles avec droits d\'accès';
...
$string['notabletooverrideroleshere'] = 'Vous ne pouvez modifier ici aucune droit d\'accès pour aucun rôle';
...
$string['overridepermissions'] = 'Définir des dérogations aux droits d\'accès';
$string['overridepermissionsforrole'] = 'Définir des dérogations pour le rôle {$a->role} dans {$a->context}';
$string['overridepermissions_help'] = 'Les dérogations aux droits d\'accès permettent d\'accorder ou de retirer des droits d\'accès spécifiques pour certaines capacités d\'un rôle dans un contexte spécifique.';
$string['overridepermissionsin'] = 'Définir des dérogations aux droits d\'accès dans {$a}';
...
$string['permission'] = 'Droit d\'accès';
$string['permission_help'] = 'Les droits d\'accès sont les réglages que vous accordez pour des capacités spécifiques. Il y a quatre possibilités pour les droits d\'accès :

* Non défini
* Autoriser : le droit d\'accès est donné pour cette capacité
* Empêcher : le droit d\'accès n\'est pas donné pour cette capacité
* Interdire : le droit d\'accès est totalement refusé pour cette capacité et ne peut pas être accordé dans un contexte inférieur (plus spécifique)';
$string['permissions'] = 'Droits d\'accès';
$string['permissionsforuser'] = 'Droits d\'accès de l\'utilisateur {$a}';
$string['permissionsincontext'] = 'Droits d\'accès dans {$a}';
...
$string['resetrolenolegacy'] = 'Réinitialiser les droits d\'accès';
...
$string['resetrolesurenolegacy'] = 'Voulez-vous vraiment réinitialiser tous les droits d\'accès définis pour le rôle « {$a->name} ({$a->shortname}) » ?';
...
$string['roleallowinfo'] = 'Sélectionner un rôle à ajouter à la liste des rôles avec droit d\'accès pour la capacité {$a->cap} dans le contexte {$a->context} :';
...
$string['role:review'] = 'Vérifier les droits d\'accès pour autres';
...
$string['roles_help'] = 'Un rôle est une collection de droits d\'accès définis pour la totalité d\'un système, et que l\'on peut attribuer à des utilisateurs déterminés dans des contextes déterminés.';
...
$string['showthisuserspermissions'] = 'Afficher les droits d\'accès de cet utilisateur';
