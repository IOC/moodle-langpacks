...
/**
 * Strings for component 'repository_boxnet', language 'fr', branch 'MOODLE_25_STABLE'
 *
...
$string['apiv1migration_message_content'] = 'Au cours de la mise à jour à Moodle 2.5.3, le plugin de dépôt Box.net a été désactivé. Pour le réactiver, veuillez le reconfigurer suivant la procédure décrite dans la documentation {$a->docsurl}.';
