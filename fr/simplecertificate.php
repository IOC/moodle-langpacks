...
/**
 * Strings for component 'simplecertificate', language 'fr', branch 'MOODLE_25_STABLE'
 *
...
$string['savecert_help'] = 'Si vous choisissez cette option, une copie du fichier pdf du certificat de chaque utilisateur est enregistré dans le dossier moddata des fichiers de cours pour ce certificat. Un lien vers le certificat a été sauvegardé pour chaque utilisateur et sera affiché dans le rapport de certification.';
