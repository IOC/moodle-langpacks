...
/**
 * Strings for component 'realtimequiz', language 'fr', branch 'MOODLE_25_STABLE'
 *
...
$string['clicknext'] = 'Cliquer sur « Suivant » quand tout le monde est pret';
...
$string['resultoverall'] = 'correct. Au total :';
...
$string['sendinganswer'] = 'Envois de la réponse';
...
$string['teacherjoinquizinstruct'] = 'Utilisez ce bouton si vous voulez tester vous même votre test.
Vous aurez aussi besoin de démarrer le test dans une fenêtre séparée.';
$string['teacherstartinstruct'] = 'Utilisez ce bouton pour démarrer le test pour les étudiants.
Vous pouvez utiliser le champ textuel pour définir un nom pour cette session afin de vous aider lors des relectures ultérieures.';
...
$string['waitstudent'] = 'En attente que les étudiants se connectent';
